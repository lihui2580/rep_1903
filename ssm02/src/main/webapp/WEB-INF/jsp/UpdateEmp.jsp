...
<body>
 ...
 <fm:form modelAttribute="emp" name="updateForm" action="${pageContext.request.contextPath }/emp/update" method="POST"> 
  ...
  <table>
    ...
    <tr>
     ...
     <td>
      ...
      <fm:select path="dept.deptno" items="${depts }" itemLabel="dname" itemValue="deptno"></fm:select>
     </td>
    </tr>
    <tr> 
     <td>经理</td>
