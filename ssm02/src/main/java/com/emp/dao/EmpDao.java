...
public interface EmpDao {
	...
	@Select("select e.empno,e.ename,e.esex,e.eage,e.esalary,"
			+ " d.deptno,d.dname,d.location,m.empno mno,m.ename mname "
			+ " from t_emp e inner join t_dept d on e.deptno=d.deptno "
			+ " inner join t_emp m on e.mgrno=m.empno")
	...
	@Select("select e.empno,e.ename,e.esex,e.eage,e.esalary,"
			+ " d.deptno,d.dname,d.location,m.empno mno,m.ename mname "
			+ " from t_emp e inner join t_dept d on e.deptno=d.deptno "
			+ " inner join t_emp m on e.mgrno=m.empno where e.empno=#{empno}")
	@ResultMap("empMapper")
	...
	@Select("select e.empno,e.ename,e.esex,e.eage,e.esalary,"
			+ " d.deptno,d.dname,d.location,m.empno mno,m.ename mname "
			+ " from t_emp e inner join t_dept d on e.deptno=d.deptno "
			+ " inner join t_emp m on e.mgrno=m.empno where d.deptno=#{deptno}")
	@ResultMap("empMapper")
	List<Emp> queryDept(@Param("deptno")String deptno);
